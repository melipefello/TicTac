    ...
    IPointerUpHandler
{
    ...
    public void UpdateSymbol(PlayerSymbol symbol)
    {
        ...
        _scaleTween.Complete();
        _scaleTween = Tween.Scale(_cardImageRoot, Vector3.zero, Vector3.one, 0.3f, Ease.OutBack);
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        var zAngle = Mathf.LerpAngle(_cardImageRoot.localEulerAngles.z, angleStep, 0.2f);
        var yAngle = Mathf.LerpAngle(_cardImageRoot.localEulerAngles.y, angleStep * 1.5f, 0.2f);
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        _sequence = Sequence.Create()
            .Group(Tween.Scale(_cardRoot, 1.5f, 0.1f))
            .Group(Tween.LocalPosition(_cardImageRoot, Vector3.down * 24, 0.1f));
    }
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        _sequence.Complete();
        _sequence = Sequence.Create()
            .Group(Tween.Scale(_cardRoot, 1f, 0.1f))
            .Chain(Tween.LocalPosition(_cardImageRoot, Vector3.zero, 0.2f, Ease.OutBounce));
